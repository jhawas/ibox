            ...
            <div class="tile-body">
                <ul class="list-group list-group-flush">
                  <li class="list-group-item">Patient: {{ 
                        ...
                        ucfirst($outPatient->patient->last_name)
                   }}</li>
                </ul>
            </div>
          </div>
              ...
              <div class="tile-body">
                ...
                <div>
                  <table class="table">
                    ...
                    <tbody>
                      @foreach ($outPatient->diagnoses as $diagnose)
                        <tr>
              ...
              <div class="tile-body">
                ...
                <div>
                  <table class="table">
                    ...
                    <tbody>
                      @foreach ($outPatient->vitalSigns as $vitalSign)
                        <tr>
                            <td>{{ $vitalSign->id }}</td>
                            <td>{{ $vitalSign->bp }}</td>
                            <td>{{ $vitalSign->t }}</td>
              ...
              <div class="tile-body">
                ...
                <div>
                  <table class="table">
                    ...
                    <tbody>
                      @foreach ($outPatient->doctorsOrders as $doctorsOrder)
                        <tr>
              ...
              <div class="tile-body">
                ...
                <div>
                  <table class="table">
                    ...
                    <tbody>
                      @foreach ($outPatient->nursesNotes as $nursesNote)
                        <tr>
                            <td>{{ $nursesNote->id }}</td>
              ...
              <div class="tile-body">
                ...
                <div>
                  <table class="table">
                    ...
                    <tbody>
                      @foreach ($outPatient->intravenousFluids as $intravenousFluid)
                        <tr>
              ...
              <div class="tile-body">
                ...
                <div>
                  <table class="table">
                    ...
                    <tbody>
                      @foreach ($outPatient->medicationAndTreatments as $medicationAndTreatment)
                        <tr>
              ...
              <div class="tile-body">
                ...
                <div>
                  <table class="table">
                    ...
                    <tbody>
                      @foreach ($outPatient->laboratory as $laboratoryTest)
                        <tr>
