...
@section('content')
    <div class="app-title">
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="tile">
            <h3 class="tile-title">Floor Form</h3>
            <form method="POST" action="{{ route('floors.update', $floor) }}">
              ...
              <div class="tile-body">
                  ...
                  <div class="form-group">
                    ...
                    <input name="code" class="form-control{{ $errors->has('code') ? ' is-invalid' : '' }}" value="{{ $floor->code }}" type="text" placeholder="Enter Code">
                    @if ($errors->has('code'))
                        <span class="invalid-feedback" role="alert">
              ...
              <div class="tile-footer">
                ...
                <a class="btn btn-secondary" href="{{ route('floors.index') }}">
