      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            ...
            <form method="POST" action="{{ route('intravenousFluids.store') }}">
              @csrf
              <div class="tile-body">
                  <div class="row">
                      <div class="col-md-6">
                          ...
                          <div class="form-group">
                            ...
                            <input name="bot_no" class="form-control{{ $errors->has('bot_no') ? ' is-invalid' : '' }}" value="{{old('bot_no')}}" type="text" placeholder="Enter bot no.">
                          ...
                          <div class="form-group">
                            ...
                            <textarea name="kind_of_solution" class="form-control{{ $errors->has('kind_of_solution') ? ' is-invalid' : '' }}"
                              placeholder="Enter kind of solution here...">{{old('kind_of_solution')}}</textarea>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input name="vol" class="form-control{{ $errors->has('vol') ? ' is-invalid' : '' }}" value="{{old('vol')}}" type="text" placeholder="Enter vol">
                            @if ($errors->has('vol'))
                                <span class="invalid-feedback" role="alert">
                          ...
                          <div class="form-group">
                            ...
                            <input name="gtss" class="form-control{{ $errors->has('gtss') ? ' is-invalid' : '' }}" value="{{old('gtss')}}" type="text" placeholder="Enter gtss">
                            @if ($errors->has('gtss'))
                                <span class="invalid-feedback" role="alert">
