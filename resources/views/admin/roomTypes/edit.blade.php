              ...
              @csrf
               <div class="tile-body">
                  <div class="form-group">
                    ...
                    <input name="code" class="form-control{{ $errors->has('code') ? ' is-invalid' : '' }}" value="{{$roomType->code}}" type="text" placeholder="Enter Code">
                    @if ($errors->has('code'))
                  ...
                  <div class="form-group">
                    ...
                    <textarea name="description" class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}"
                      placeholder="Enter Description here...">{{$roomType->description}}</textarea>
