      ...
      <div class="row">
        <div class="col-md-6">
          <div class="tile">
            ...
            <form method="POST" action="{{ route('nursesNotes.store') }}">
              @csrf
              <div class="tile-body">
                  ...
                  <div class="form-group">
                    ...
                    <textarea name="focus" class="form-control{{ $errors->has('focus') ? ' is-invalid' : '' }}"
                      placeholder="Enter focus here...">{{old('focus')}}</textarea>
                    @if ($errors->has('focus'))
                        <span class="invalid-feedback" role="alert">
                  ...
                  <div class="form-group">
                    ...
                    <textarea name="data_action_response" class="form-control{{ $errors->has('data_action_response') ? ' is-invalid' : '' }}"
                      placeholder="Enter data_action_response here...">{{old('data_action_response')}}</textarea>
