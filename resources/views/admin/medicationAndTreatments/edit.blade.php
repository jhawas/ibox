      ...
      <div class="row">
        <div class="col-md-6">
          <div class="tile">
            ...
            <form method="POST" action="{{ route('medicationAndTreatments.update', $medicationAndTreatment) }}">
              @method('PUT')
              @csrf
              <div class="tile-body">
                  <div class="form-group">
                    ...
                    <select class="select2 form-control{{ $errors->has('patientRecord') ? ' is-invalid' : '' }}" style="width: 100%;" name="patientRecord">
                      ...
                      @foreach ($patientRecords as $patientRecord)
                        <option {{ $medicationAndTreatment->patient_record_id == $patientRecord->id ? 'selected' : '' }} value="{{ $patientRecord->id }}">
                  ...
                  <div class="form-group">
                    ...
                    <input name="medicine" class="form-control{{ $errors->has('medicine') ? ' is-invalid' : '' }}" value="{{$medicationAndTreatment->medicine}}" type="text" placeholder="Enter medicine">
                  ...
                  <div class="form-group">
                    ...
                    <input name="date" class="form-control{{ $errors->has('date') ? ' is-invalid' : '' }}" value="{{$medicationAndTreatment->date}}" type="date" placeholder="Enter date">
                    @if ($errors->has('date'))
                        <span class="invalid-feedback" role="alert">
                  ...
                  <div class="form-group">
                    ...
                    <input name="time" class="form-control{{ $errors->has('time') ? ' is-invalid' : '' }}" value="{{$medicationAndTreatment->time}}" type="time" placeholder="Enter time">
                    @if ($errors->has('time'))
                        <span class="invalid-feedback" role="alert">
                  ...
                  <div class="form-group">
                    ...
                    <textarea name="remarks" class="form-control{{ $errors->has('remarks') ? ' is-invalid' : '' }}"
                      placeholder="Enter remarks here...">{{$medicationAndTreatment->remarks}}</textarea>
